...
export default function AddOrEditMotherCulture() {
  ...
  const {data: motherCulture, error: motherCultureError, isLoading: motherCultureLoading} = useSWR(
    isEditing ? `mother-cultures/${id}` : null,
  ...
  const {trigger: saveMotherCulture, error: saveError} = useSWRMutation('mother-cultures', save);
  ...
  return(
    ...
    dark:from-gray-900 dark:via-slate-900 dark:to-indigo-950 p-6">
      ...
      <div className="max-w-3xl mx-auto">
        <div className="backdrop-blur-xl bg-white/70 dark:bg-gray-800/70 rounded-3xl 
        shadow-2xl border border-white/20 dark:border-gray-700/30 p-8">
          <AsyncData error={motherCultureError || speciesError || saveError} 
