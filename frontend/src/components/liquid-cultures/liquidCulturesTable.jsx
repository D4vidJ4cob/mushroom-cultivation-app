import LiquidCultureRow from './LiquidCultureRow';
import { FaFlask } from 'react-icons/fa';

export default function LiquidCulturesTable({cultureData, onEdit, onDelete}) {

  if (cultureData.length === 0) {
    return (
      <div className="text-center py-16 px-4">
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-full 
        bg-gradient-to-br from-teal-100 to-cyan-100 dark:from-teal-900/30 
        dark:to-cyan-900/30 mb-6">
          <FaFlask className="w-10 h-10 text-teal-500 dark:text-teal-400" />
        </div>
        <p className="text-gray-600 dark:text-gray-400 text-xl font-medium">No liquid cultures found</p>
      ...
      <table className="w-full">
        <thead>
          ...
          border-b border-gray-200/50 dark:border-gray-700/50">
            ...
            <th className="text-left p-5 font-semibold text-gray-700 
            dark:text-gray-300 text-sm uppercase tracking-wider">Species</th>

            <th className="text-left p-5 font-semibold text-gray-700 
            dark:text-gray-300 text-sm uppercase tracking-wider">Inoculation Date</th>

            <th className="text-left p-5 font-semibold text-gray-700 
            dark:text-gray-300 text-sm uppercase tracking-wider">Characteristic</th>
