...
export default function AddOrEditLiquidCulture() {
  ...
  const {
    data: liquidCulture,
    error: liquidCultureError,
    isLoading: liquidCultureLoading,
  } = useSWR(isEditing ? `liquid-cultures/${id}` : null, () =>
  ...
  const { trigger: saveLiquidCulture, error: saveError } = useSWRMutation(
    'liquid-cultures',
    save,
  );
    ...
    >
      ...
      <div className="max-w-3xl mx-auto">
        <div className="content-card">
          <AsyncData
            error={liquidCultureError || speciesError || saveError}
