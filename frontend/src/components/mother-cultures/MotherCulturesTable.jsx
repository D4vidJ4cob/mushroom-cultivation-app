import MotherCultureRow from './MotherCultureRow';
import { FaFlask } from 'react-icons/fa';

export default function MotherCulturesTable({cultureData, onEdit, onDelete}) {
    ...
    return (
      <div className="text-center py-16 px-4">
        ...
        <p className="text-gray-400 dark:text-gray-500 text-sm mt-2">
          Try adjusting your search or create your first culture
        </p>
      </div>
    );
  }
      ...
      <table className="w-full">
        <thead>
          ...
          border-b border-gray-200/50 dark:border-gray-700/50" data-cy="mother_culture">
            ...
            dark:text-gray-300 text-sm uppercase tracking-wider" data-cy="mother_culture_id">
              ID</th>

            <th className="text-left p-5 font-semibold text-gray-700 
            dark:text-gray-300 text-sm uppercase tracking-wider" data-cy="mother_culture_name">
              Name</th>

            <th className="text-left p-5 font-semibold text-gray-700 
            dark:text-gray-300 text-sm uppercase tracking-wider">
              Species</th>

            <th className="text-left p-5 font-semibold text-gray-700 
            dark:text-gray-300 text-sm uppercase tracking-wider" data-cy="mother_culture_inoculation">
              Inoculation Date</th>

            <th className="text-left p-5 font-semibold text-gray-700 
            dark:text-gray-300 text-sm uppercase tracking-wider" data-cy="mother_culture_characteristic">
              Characteristic</th>
