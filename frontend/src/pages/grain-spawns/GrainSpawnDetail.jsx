...
const GrainSpawnDetail = () => {
  ...
  const { data: grainSpawn, error, isLoading } = useSWR(
    `grain-spawns/${id}`,
    getById,
  );
          ...
          <AsyncData error={error} loading={isLoading}>
            {grainSpawn && (
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  ...
                  <div className={`p-6 rounded-xl border ${
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm font-medium">Shaken</p>
                    </div>
                    <p className="text-gray-800 dark:text-gray-200 font-semibold text-xl">
                  ...
                  <div className={`p-6 rounded-xl border ${
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm font-medium">Contamination</p>
                    </div>
                    <p className="text-gray-800 dark:text-gray-200 font-semibold text-xl">
                      {grainSpawn.contaminationStatus === true 
                        ? '❌ Contaminated' 
                ...
                <div className="p-6 rounded-xl bg-purple-50 dark:bg-purple-900/20 border 
                border-purple-200/50 dark:border-purple-700/50 mb-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm font-medium">Source</p>
                  </div>
                ...
                {grainSpawn.substrates && grainSpawn.substrates.length > 0 && (
                  <div className="p-6 rounded-xl bg-indigo-50 dark:bg-indigo-900/20 border 
                      ...
                      {grainSpawn.substrates.map((substrate) => (
                        ...
                        >
                          <p className="text-gray-700 dark:text-gray-300">
                            Substrate #{substrate.id} - Inoculated: {formatDate(substrate.inoculationDate)}
