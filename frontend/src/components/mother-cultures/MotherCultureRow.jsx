...
export default function MotherCultureRow({ id, culture, onDelete = () => {} }) {
  ...
  return (
    ...
    data-cy={`mother_cultures_row_${id}`}>
      ...
      <td className="p-5">
        <div className="flex items-center justify-end gap-2">
          ...
          <button 
            ...
            relative overflow-hidden"
            aria-label="Delete"
            data-cy="delete_motherCulture_btn" 
          >
            <span className="absolute inset-0 bg-white/20 scale-0 group-hover/btn:scale-100 
            transition-transform duration-300 rounded-xl"></span>
