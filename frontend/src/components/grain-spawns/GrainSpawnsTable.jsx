  ...
  if (grainSpawnData.length === 0) {
    return (
      <div className="text-center py-16 px-4">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-xl font-medium">No grain spawns found</p>
      ...
      <table className="w-full">
        <thead>
          ...
          border-b border-gray-200/50 dark:border-gray-700/50">
            ...
            <th className="text-left p-5 font-semibold text-gray-700 
            dark:text-gray-300 text-sm uppercase tracking-wider">Shaken?</th>

            <th className="text-left p-5 font-semibold text-gray-700 
            dark:text-gray-300 text-sm uppercase tracking-wider">Parent</th>
            <th className="text-left p-5 font-semibold text-gray-700
